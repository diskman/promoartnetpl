...
permalink: /realizacje/reklama-zewnetrzna/
description: Wybrane realizacje z zakresu reklamy zewnętrznej.
gallery_groups:
  - title: ROLL UP / ŚCIANKI
    anchor: roll-up-scianki
    icon: indoor
    imageFolder: '/assets/img/portfolio/reklama-wizualna/rollup'
  - title: BANER, BILLBOARDY, SIATKI MESH, TABLICE
    anchor: baner-billboardy-siatki-mesh-tablice
    icon: outdoor
    imageFolder: '/assets/img/portfolio/reklama-wizualna/banner'
  ...
  - title: FLAGI, LEZAKI, NAMIOTY
    ...
    icon: raport
    imageFolder: '/assets/img/portfolio/reklama-wizualna/flagi'
---
